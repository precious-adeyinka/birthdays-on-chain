...
export default function UpdateGoal({birthdayId, goal, onGoalUpdatedDone}: {birthdayId:number; goal:Goal; onGoalUpdatedDone:() => void}) {
...
const GoalUpdateForm = ({birthdayId, onGoalUpdated, goal}: {birthdayId: number; onGoalUpdated: () => void; goal:Goal;}) => {
  ...
  return (
    <div className="w-full h-auto">
      {error ? (<div className="text-red-500 text-center w-11/12 md:w-full text-xs">
          ...
          >
            {loading ? (
              <div className="flex items-center justify-center space-x-2">
                <span className="text-black text-xs">Updating your goal...</span>
